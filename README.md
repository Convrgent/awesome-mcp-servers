...
- <img src="https://avatars.githubusercontent.com/u/262647931?v=4" height="14" /> [AEO Scanner](https://github.com/Convrgent/aeo-scanner-mcp) - AI search visibility audit for any website. Checks AEO score and Agent Readiness score, with copy-pasteable fix code. Available as remote MCP or local via `uvx aeo-scanner`.
